...
The method requires careful attention to **Parallel trends** assumption which can't be tested directly but can be signalled by analyzing pre-treatment data.
