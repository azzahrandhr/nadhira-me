...
subtitle: "Replication of Chen, Pan and Xu (2016)"
...
---
# Sources of Authoritarian Responsiveness: A Field Experiment in China : Replication of Chen, Pan and Xu (2016)
```{r}
#| label: setup
#| include: false
...
In one of my class project, I got to pick a research study to replicate, and I immediately knew I wanted to work with this one when saw it online because it reminds me so much of what I see happening back home.

If you've ever spent time on Indonesian social media, you know how powerful netizens can be. A complaint about bad service goes viral on Twitter? Companies scramble to respond. A politician's family member gets caught doing something shady and people start talking on Instagram? Before you know it, it's on the national news. I've watched the power of people coming together online to make their voices heard, and actually getting results.

While this research is not about that, it give a glimpse of insight into how this all works. It's about understanding the mechanisms behind it. <i>What makes some online movements take off while others fizzle out? How do institutions actually respond to online pressure?</i> These are questions I find fascinating.
...
For the Causal Effect of Treatments on Government Responses replication, I find that it closely matches the original findings. The threat of collective action increases government responsiveness by about 7.7 pp in unconditional models (all counties) and about 10.1 pp in conditional models (counties where posts were successfully made). The threat of tattling to upper-level government shows similar effects, increasing responsiveness by 6.8 pp unconditionally and 8.3 pp conditionally. Claims of CCP loyalty show smaller, statistically insignificant effects of around 3–4 pp. These results are robust to the inclusion of prefectural fixed effects and sociodemographic controls.
